...
def go_test_page():
    if request.method == 'POST':
        flash("Спасибо за прохождение теста!")
        return redirect('/')
    test_name = "Первая анкета (>_<)"
    question_list = [{"id": 0, "name": "Сколько Вам лет?", "variants": ["0-10", "10-20", "20-30",
                                                                        "30-40", "50-60", "60+"]},
                     {"id": 1, "name": "Как Ваше настроение?", "variants": ["Очень хорошо",
                                                                            "Хорошо", "Нормально",
                                                                            "Плохо", "Очень плохо"]},
                     {"id": 2, "name": "Как Вам выступление?", "variants": ["Очень хорошо",
                                                                            "Хорошо","Нормально",
                                                                            "Плохо", "Очень плохо"]}]
